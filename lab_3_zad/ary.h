...
typedef struct wartosc {
  double dol, gora;     // "zwykły" przedział to [dol, gora], a antyprzedzial to [-HUGE_VAL, dol] U [gora, HUGE_VAL]
  bool czy_anty;        // = true dla antyprzedziału, = false dla "zwykłego" przedziału
  } wartosc;
